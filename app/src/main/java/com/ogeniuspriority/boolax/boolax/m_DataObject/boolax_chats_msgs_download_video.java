...
public class boolax_chats_msgs_download_video extends AsyncTask<Integer, Integer, Boolean> {
    int downloadedSize;
    int totalSize;
    ...
    public boolax_chats_msgs_download_video(Context currCtx, String dwnload_file_path,
                                            String filename_video,
    ...
    protected Boolean doInBackground(Integer... integers) {
        ...
        return this.downloadFileImages(dwnload_file_path, filename_video);

    }

    private boolean downloadFileImages(String dwnload_file_path, String filename_video) {
        ...
        try {
            ...
            File file = new File(directory, filename_video);
