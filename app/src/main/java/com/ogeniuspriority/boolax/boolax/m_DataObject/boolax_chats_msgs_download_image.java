...
public class boolax_chats_msgs_download_image extends AsyncTask<Integer, Integer, Boolean> {
    int downloadedSize;
    int totalSize;
    ...
    public boolax_chats_msgs_download_image(Context currCtx, String dwnload_file_path,
                                            String filename_image,
    ...
    protected Boolean doInBackground(Integer... integers) {
        ...
        return this.downloadFileImages(dwnload_file_path, filename_image);

    }

    private boolean downloadFileImages(String dwnload_file_path, String filename_image) {
        ...
        try {
            ...
            File file = new File(directory, filename_image);
