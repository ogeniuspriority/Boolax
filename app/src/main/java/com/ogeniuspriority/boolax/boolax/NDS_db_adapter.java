...
public class NDS_db_adapter {
    ...
    public static final String MYDATABASE_NDS_TABLE_USER_CREDS_LOGIN_TYPE = "NDS_internal_2017_ogenius_nds_db_normal_users_login_type";
    public static final String MYDATABASE_NDS_TABLE_USER_CREDS_SOCIAL_MEDIA_ID = "NDS_internal_2017_ogenius_nds_db_normal_users_social_media_id";
    //---------------------
    ...
    private static final String SCRIPT_CREATE_NDS_TABLE_USER_CREDS =
            "create table " + MYDATABASE_NDS_TABLE_USER_CREDS + " ("
                    ...
                    + MYDATABASE_NDS_TABLE_USER_CREDS_LOGIN_TYPE + " text ,"
                    + MYDATABASE_NDS_TABLE_USER_CREDS_SOCIAL_MEDIA_ID + " text ,"
