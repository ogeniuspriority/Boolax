 ...
 */
public class Boolax_favorite_booers_custom_adapter_for_booers extends BaseAdapter implements GlideModule {
    Context c;
    ...
    public Boolax_favorite_booers_custom_adapter_for_booers(Context c, ArrayList<Boolax_favorite_booers_boos_objects> my_Community_Posts_) {
