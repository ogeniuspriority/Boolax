 ...
 */
public class Boolax_actual_lovers_send_msg_special extends AsyncTask<Void, Void, String> {
    Context c;
    //----------------
    String myRemoteId;
    String me_id;
    ...
    public Boolax_actual_lovers_send_msg_special(Context c, String theRemoteUrl, String me_id, String receiver_id, String messageType, String message_url, String streamOfAlready_saved_messages, String theActualMessage, ListView boolax_boos_list, String local_actual_msg_id, int scrollIndex) {
        this.c = c;
        this.me_id = me_id;
        ...
        this.local_actual_msg_id = local_actual_msg_id;
    ...
    protected void onPostExecute(String jsonData) {
        ...
        if (jsonData == null) {
            ...
            if (allSavedMessages.moveToLast()) {
                ...
                boolax_boos_list.setSelection(scrollIndex);
