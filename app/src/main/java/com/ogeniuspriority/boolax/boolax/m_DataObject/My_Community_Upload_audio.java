 ...
 */
public class My_Community_Upload_audio extends AsyncTask<Integer, Integer, String> {
    Context c;
    ...
    public My_Community_Upload_audio(Context c,Context currCtx, String selectedPath,
                                     String uploadedfile,
                                     String remoteIdOfReceipient, String myRemoteId, String CaptionDescr, String msgType, ListView myMsgs,String theLocalId) {
        this.c = c;
        ...
        progress=new ProgressDialog(currCtx);
        mProgressStatus = 0;
    ...
    protected void onPostExecute(String jsonData) {
        ...
        if (jsonData == null) {
            ...
            Toasty.error(c, "Suggestion not received!", Toast.LENGTH_SHORT).show();
            ...
            if (allSavedMessages.moveToLast()) {
                ...
                myMsgs.setSelection(theMessages.getCount() - 1);
    ...
    private String doFileUpload_image() throws IOException {
        ...
        String jsonString = "";
        String urlString = Config.BOOLAX_ACCOUNT_LOAD_THE_ACTUAL_LOVERS_CHATS_AUDIOS_MSGS_SEND;
        ...
        try {
            ...
            e.printStackTrace();
            Log.w("Tring","YesOfC uuu "+e.toString()+"-"+e.getMessage());
