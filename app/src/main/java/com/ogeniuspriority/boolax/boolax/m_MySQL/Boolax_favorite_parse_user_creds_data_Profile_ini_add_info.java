...
import com.ogeniuspriority.boolax.boolax.boolax_additional_profile_features;
 ...
 */
public class Boolax_favorite_parse_user_creds_data_Profile_ini_add_info extends AsyncTask<Void, Void, Boolean> {
    Context c;
    ...
    public Boolax_favorite_parse_user_creds_data_Profile_ini_add_info(Context c, String jsonData) {
        this.c = c;
    ...
    protected void onPostExecute(Boolean isParsed) {
        ...
        if (isParsed) {
            ...
            if (!new database_enablers(c).findIfUserCreated()) {
                db.close();
                db.openToWrite();
                //-----

                if (db.update_MYDATABASE_NDS_TABLE_BOOLAX_USER_locally(fname[0], lname[0],
                        gender[0], username[0], birthdate[0], country[0], province[0], login_type[0], remote_id[0])) {
                    Intent i = new Intent(c, boolax_additional_profile_features.class);
