 ...
 */
public class My_Community_Upload_audio_special extends AsyncTask<Integer, Integer, String> {
    ...
    public My_Community_Upload_audio_special(Context currCtx, String selectedPath,
                                             String uploadedfile,
                                             String remoteIdOfReceipient, String myRemoteId, String CaptionDescr, String msgType, ListView myMsgs, String theLocalId, int last_index) {
    ...
    protected void onPostExecute(String jsonData) {
        ...
        if (jsonData == null) {
            ...
            if (allSavedMessages.moveToLast()) {
                ...
                myMsgs.setSelection(last_index);
