...
public class Boolax_favorite_Boo_Events extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_boolax_favorite__boo__events);
        // Initilization
        ...
        final ImageView boo_favorite_events_find = (ImageView) findViewById(R.id.boo_favorite_events_find);
        ...
        boo_favorite_booers_boos_find.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // startActivity(i);
                Intent i = new Intent(Boolax_favorite_Boo_Events.this, Boolax_favorite_Boo_Booers.class);
                startActivity(i);
        ...
        boo_favorite_events_find.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ToolTip.Builder builder = new ToolTip.Builder(Boolax_favorite_Boo_Events.this, boo_favorite_events_find, theTeste, "Create Events! See above!", ToolTip.POSITION_ABOVE);
        ...
        boo_favorite_groups_find.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Boolax_favorite_Boo_Events.this, Boolax_favorite_Groups.class);
                startActivity(i);
        ...
        boo_favorite_quick_boos_find.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Boolax_favorite_Boo_Events.this, Boolax_favorite_Quick_boos.class);
                startActivity(i);
            }
        });
    }
