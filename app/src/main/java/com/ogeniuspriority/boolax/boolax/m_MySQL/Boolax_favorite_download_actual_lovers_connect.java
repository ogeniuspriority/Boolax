 ...
 */
public class Boolax_favorite_download_actual_lovers_connect {
    public static HttpURLConnection connect(String theRemoteUrl, String myRemoteId, String streamOfActualLovers) {
        ...
        try {
            ...
            data = data + "&" + URLEncoder.encode("streamOfActualLovers", "UTF-8")
                    + "=" + URLEncoder.encode(streamOfActualLovers, "UTF-8");
