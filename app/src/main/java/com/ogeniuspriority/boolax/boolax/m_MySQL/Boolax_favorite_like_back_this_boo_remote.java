...
import com.ogeniuspriority.boolax.boolax.boolax_booers;
 ...
 */
public class Boolax_favorite_like_back_this_boo_remote extends AsyncTask<Void, Void, String> {
    Context c;
    //----------------
    String myRemoteId;
    String theRemoteUrl;
    ...
    public Boolax_favorite_like_back_this_boo_remote(Context c, String theRemoteUrl, String myRemoteId, String TheOtherParty, View view, DialogSheet MyBooers_popup, String tag, SwipeRefreshLayout pull_to_refresh) {
        this.c = c;
        //---------------
        ...
        this.view = view;
        this.MyBooers_popup = MyBooers_popup;
        this.tag = tag;
    ...
    protected void onPostExecute(String jsonData) {
        ...
        if (jsonData == null) {
            ...
            if (jsonData.contains("1000") && !TheOtherParty.isEmpty()) {
                ...
                if (thDb.update_THIS_BOOER_VISIBILITY(TheOtherParty)) {
                    MyBooers_popup.dismiss();
                    ...
                    animate.setAnimationListener(new Animation.AnimationListener() {
                        ...
                        public void onAnimationEnd(Animation animation) {
                            ...
                            if (tag.equalsIgnoreCase("1")) {
                                final DialogSheet got_a_boo = new DialogSheet(c)
                                        .setBackgroundColor(Color.parseColor("#9C000000"))
                                        // Your custom background color
                                        .setCancelable(true).setView(R.layout.boo_favorite_booers_boos_you_got_a_boo);
                                // Access dialog custom inflated view
                                View inflatedView = got_a_boo.getInflatedView();
                                got_a_boo.show();
                                CircleImageView boo_real = (CircleImageView) inflatedView.findViewById(R.id.boo_real);
                                new My_Boolax_boxes_find_avatars(c, Config.BOOLAX_FAVORITE_BOOERS_GET_BOOS_AVATARS_DATA_URL.toString(), TheOtherParty, boo_real).execute();
                            ...
                            pull_to_refresh.post(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    new Boolax_favorite_booers_download_booers(c, Config.BOOLAX_FAVORITE_BOOERS_GET_BOOERS, gender, remote_id_me, boolax_booers.boolax_booers_list, pull_to_refresh, temp_boos_ids).execute();
    ...
    private String downloadData() throws UnsupportedEncodingException {
        ...
        HttpURLConnection con = Boolax_favorite_like_back_this_boo_connect.connect(theRemoteUrl, myRemoteId, TheOtherParty, tag);
        if (con == null) {
            return null;
        }
        try {
