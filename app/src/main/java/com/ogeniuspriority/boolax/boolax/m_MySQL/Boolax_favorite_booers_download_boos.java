 ...
 */
public class Boolax_favorite_booers_download_boos extends AsyncTask<Void, Void, String> {
    Context c;
    ...
    public Boolax_favorite_booers_download_boos(Context c, String theRemoteUrl, String UserGender, String myRemoteId, ListView boolax_boos_list, SwipeRefreshLayout pull_to_refresh, String streamOfMyAcknowledgesBoos) {
        this.c = c;
    ...
    protected void onPostExecute(String jsonData) {
        ...
        if (jsonData == null) {
            ...
            Log.w("json_00", jsonData);

            //parse the json--
            new Boolax_favorite_booers_parse_boos_save_local(c, jsonData, boolax_boos_list).execute();
