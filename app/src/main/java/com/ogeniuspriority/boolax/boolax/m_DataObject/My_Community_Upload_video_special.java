 ...
 */
public class My_Community_Upload_video_special extends AsyncTask<Integer, Integer, String> {
   ...
   // private Handler mHandler = new Handler();
    ...
    public My_Community_Upload_video_special(Context currCtx, String selectedPath,
                                             String uploadedfile,
                                             String remoteIdOfReceipient, String myRemoteId, String CaptionDescr, String msgType, ListView myMsgs, String theLocalId,int lastIndex_) {
    ...
    protected void onPostExecute(String jsonData) {
        ...
        if (jsonData == null) {
            ...
            if (allSavedMessages.moveToLast()) {
                ...
                myMsgs.setSelection(lastIndex_);
    ...
    private String doFileUpload_image() throws IOException {
        ...
        String jsonString = "";
        String urlString = Config.BOOLAX_ACCOUNT_LOAD_THE_ACTUAL_LOVERS_CHATS_VIDEOS_MSGS_SEND;
