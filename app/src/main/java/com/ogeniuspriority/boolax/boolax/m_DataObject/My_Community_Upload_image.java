 ...
 */
public class My_Community_Upload_image extends AsyncTask<Integer, Integer, String> {
    Context c;
    ...
    public My_Community_Upload_image(Context c,Context currCtx, String selectedPath,
                                     String uploadedfile,
