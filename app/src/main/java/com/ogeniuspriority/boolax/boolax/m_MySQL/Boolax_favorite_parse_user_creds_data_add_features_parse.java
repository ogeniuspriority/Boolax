...
import com.ogeniuspriority.boolax.boolax.boolax_phone_email_verify;
 ...
 */
public class Boolax_favorite_parse_user_creds_data_add_features_parse extends AsyncTask<Void, Void, Boolean> {
    Context c;
    ...
    public Boolax_favorite_parse_user_creds_data_add_features_parse(Context c, String jsonData) {
        this.c = c;
    ...
    protected void onPostExecute(Boolean isParsed) {
        ...
        if (isParsed) {
            ...
            if (new database_enablers(c).findIfUserCreated_stage2_account_complete()) {
                ...
                if (db.update_MYDATABASE_NDS_TABLE_BOOLAX_USER_locally_add_new_features(remote_id[0],
                        how_attractive[0],
                        about_life[0],
                        about_love[0],
                        love_relationship[0],
                        lover_criteria[0],
                        your_hobbies[0], religious_affiliation[0]
                        , academics_and_work[0])) {
                    Intent i = new Intent(c, boolax_phone_email_verify.class);
